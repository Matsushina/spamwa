...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" Subrike dulu bang")
    time.sleep(1)
    os.system("xdg-open https://www.youtube.com/channel/UCmLkih19vLCwk3IgPnbJX1Q")
    time.sleep(5)
    os.system("clear")
...
def dark_time(start_minute, start_second):
    total_second = start_minute * 3 + start_second
    while total_second:
        mins, secs = divmod(total_second, 3)
